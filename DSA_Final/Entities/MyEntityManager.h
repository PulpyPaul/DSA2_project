...
public:
	...
	*/
	...
	/*
	USAGE: Gets the number of entities held in the entity manager
	ARGUMENTS: ---
	OUTPUT: Number of entities in the manager
	*/
	uint GetEntityCount();
	/*
	...
	*/
	...
	/*
	USAGE: Sets whether an object collides with objects
	ARGUMENTS:
	-	bool a_bHasCollisions -> whether the entity has collisions
	-	uint a_uIndex -> index in the list of entities; if less than 0 it will add it to the last in the list
	OUTPUT: ---
	*/
	void SetHasCollisions(bool a_bHasCollisions, uint a_uIndex = -1);
	/*
	USAGE: Sets whether an object collides with objects
	ARGUMENTS:
	-	bool a_bHasCollisions -> whether the entity has collisions
	...
	OUTPUT: ---
	*/
	void SetHasCollisions(bool a_bHasCollisions, String a_sUniqueID);
	/*
